...
const checkCertPaymentStatus = asyncHandler(async (req, res) => {
  ...
  const PAYMENT_CUTOFF = new Date('2026-08-06T18:29:59.000Z'); // Aug 6 2026 11:59 PM IST — students enrolled before this get free certificates // Students enrolled before Aug 6 2026 get free certificates
