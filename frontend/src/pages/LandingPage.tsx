        ...
        <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr 1fr 1fr', gap: '2.5rem', marginBottom: '3rem', maxWidth: 1100, margin: '0 auto 3rem' }} className="lp-grid-1">
          <div>
            ...
            <div style={{ display: 'flex', gap: '0.75rem' }}>
              <a href="https://hiresnix.co.in" style={{ width: 36, height: 36, borderRadius: 10, background: 'rgba(255,255,255,0.06)', border: '1px solid rgba(255,255,255,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#6b7a99', textDecoration: 'none', fontSize: '0.9rem', transition: 'all 0.2s' }}
              ...
              <a href="https://linkedin.com" style={{ width: 36, height: 36, borderRadius: 10, background: 'rgba(255,255,255,0.06)', border: '1px solid rgba(255,255,255,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#6b7a99', textDecoration: 'none', fontSize: '0.75rem', fontWeight: 700, fontFamily: 'sans-serif', transition: 'all 0.2s' }}
                onMouseEnter={e => { (e.currentTarget as HTMLAnchorElement).style.borderColor = '#3b82f6'; (e.currentTarget as HTMLAnchorElement).style.color = '#60a5fa'; }}
