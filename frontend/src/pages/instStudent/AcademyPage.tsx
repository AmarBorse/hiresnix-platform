...
const YT: Record<string,string> = {
  // ── PYTHON (Bro Code Full Course) ────────────────────────────
  "What is Python?":         "ix9cRaBkVe0",
  "Setting Up Python":       "ix9cRaBkVe0?start=60",
  "Your First Program":      "ix9cRaBkVe0?start=300",
  "Variables & Data Types":  "ix9cRaBkVe0?start=600",
  "Type Conversion":         "ix9cRaBkVe0?start=900",
  "Arithmetic Operators":    "ix9cRaBkVe0?start=1200",
  "Comparison Operators":    "ix9cRaBkVe0?start=1500",
  "Logical Operators":       "ix9cRaBkVe0?start=1800",
  "If-Else Statements":      "ix9cRaBkVe0?start=2100",
  "For Loops":               "ix9cRaBkVe0?start=2700",
  "While Loops":             "ix9cRaBkVe0?start=3000",
  "Break & Continue":        "ix9cRaBkVe0?start=3300",
  "Functions":               "ix9cRaBkVe0?start=4200",
  "Parameters & Return":     "ix9cRaBkVe0?start=4500",
  "Lambda Functions":        "ix9cRaBkVe0?start=4800",
  "Recursion":               "ix9cRaBkVe0?start=5100",
  "Decorators":              "ix9cRaBkVe0?start=5400",
  "Lists":                   "ix9cRaBkVe0?start=5700",
  "Tuples":                  "ix9cRaBkVe0?start=6000",
  "Dictionaries":            "ix9cRaBkVe0?start=6300",
  "Sets":                    "ix9cRaBkVe0?start=6600",
  "List Comprehensions":     "ix9cRaBkVe0?start=6900",
  "String Methods":          "ix9cRaBkVe0?start=7200",
  "File Handling":           "ix9cRaBkVe0?start=7500",
  "Exception Handling":      "ix9cRaBkVe0?start=7800",
  "Classes & Objects":       "ix9cRaBkVe0?start=8100",
  "Inheritance":             "ix9cRaBkVe0?start=8400",
  "Encapsulation":           "ix9cRaBkVe0?start=8700",
  "Polymorphism":            "ix9cRaBkVe0?start=9000",
  "Modules & Packages":      "ix9cRaBkVe0?start=9300",
  "pip & Libraries":         "ix9cRaBkVe0?start=9600",
  "Generators":              "ix9cRaBkVe0?start=9900",
  "Regular Expressions":     "ix9cRaBkVe0?start=10200",
  "Build a Calculator":      "ix9cRaBkVe0?start=10500",
  "Build a To-Do App":       "ix9cRaBkVe0?start=11000",
  "Build a Quiz Game":       "ix9cRaBkVe0?start=11500",
  "Build a Web Scraper":     "ix9cRaBkVe0?start=12000",
  "Final Python Project":    "ix9cRaBkVe0?start=12500",

  // ── JAVASCRIPT (Bro Code) ─────────────────────────────────────
  "What is JavaScript?":     "lfmg-oAi-NA",
  "Variables (let/const/var)":"lfmg-oAi-NA?start=300",
  "JS Data Types":           "lfmg-oAi-NA?start=600",
  "Template Literals":       "lfmg-oAi-NA?start=900",
  "JS Functions":            "lfmg-oAi-NA?start=1800",
  "Arrow Functions":         "lfmg-oAi-NA?start=2100",
  "Arrays":                  "lfmg-oAi-NA?start=2700",
  "Objects":                 "lfmg-oAi-NA?start=3000",
  "Destructuring":           "lfmg-oAi-NA?start=3300",
  "Spread & Rest":           "lfmg-oAi-NA?start=3600",
  "DOM Manipulation":        "lfmg-oAi-NA?start=5400",
  "Event Listeners":         "lfmg-oAi-NA?start=5700",
  "Fetch API":               "lfmg-oAi-NA?start=7200",
  "Promises":                "lfmg-oAi-NA?start=7500",
  "Async Await":             "lfmg-oAi-NA?start=7800",
  "Error Handling":          "lfmg-oAi-NA?start=8100",
  "ES6+ Features":           "lfmg-oAi-NA?start=8400",
  "Local Storage":           "lfmg-oAi-NA?start=8700",
  "Build a Todo App (JS)":   "lfmg-oAi-NA?start=9000",
  "Build a Weather App":     "lfmg-oAi-NA?start=9600",
  "Final JS Project":        "lfmg-oAi-NA?start=10000",

  // ── JAVA (Bro Code) ──────────────────────────────────────────
  "What is Java?":           "xk4_1vDrzzo",
  "Java Setup & Hello World":"xk4_1vDrzzo?start=120",
  "Java Variables":          "xk4_1vDrzzo?start=600",
  "Java Data Types":         "xk4_1vDrzzo?start=900",
  "Java Operators":          "xk4_1vDrzzo?start=1200",
  "Java If-Else":            "xk4_1vDrzzo?start=1800",
  "Java Loops":              "xk4_1vDrzzo?start=2400",
  "Java Arrays":             "xk4_1vDrzzo?start=3000",
  "Java Methods":            "xk4_1vDrzzo?start=3600",
  "Java OOP - Classes":      "xk4_1vDrzzo?start=5400",
  "Java Inheritance":        "xk4_1vDrzzo?start=6000",
  "Java Polymorphism":       "xk4_1vDrzzo?start=6600",
  "Java Interfaces":         "xk4_1vDrzzo?start=7200",
  "Java Exception Handling": "xk4_1vDrzzo?start=7800",
  "Java Collections":        "xk4_1vDrzzo?start=8400",
  "Java Generics":           "xk4_1vDrzzo?start=9000",
  "Java File I/O":           "xk4_1vDrzzo?start=9600",
  "Java Threads":            "xk4_1vDrzzo?start=10200",
  "Java Streams":            "xk4_1vDrzzo?start=10800",
  "Java Lambda":             "xk4_1vDrzzo?start=11400",
  "Build a Bank App":        "xk4_1vDrzzo?start=12000",
  "Build a Student DB":      "xk4_1vDrzzo?start=12600",
  "Final Java Project":      "xk4_1vDrzzo?start=13000",

  // ── C++ (Bro Code) ───────────────────────────────────────────
  "What is C++?":            "-TkoO8Z07hI",
  "C++ Setup":               "-TkoO8Z07hI?start=120",
  "C++ Variables":           "-TkoO8Z07hI?start=600",
  "C++ Data Types":          "-TkoO8Z07hI?start=900",
  "C++ Operators":           "-TkoO8Z07hI?start=1200",
  "C++ If-Else":             "-TkoO8Z07hI?start=1800",
  "C++ Loops":               "-TkoO8Z07hI?start=2400",
  "C++ Arrays":              "-TkoO8Z07hI?start=3000",
  "C++ Functions":           "-TkoO8Z07hI?start=3600",
  "C++ Pointers":            "-TkoO8Z07hI?start=5400",
  "C++ References":          "-TkoO8Z07hI?start=6000",
  "C++ OOP":                 "-TkoO8Z07hI?start=6600",
  "C++ Inheritance":         "-TkoO8Z07hI?start=7200",
  "C++ Polymorphism":        "-TkoO8Z07hI?start=7800",
  "C++ STL":                 "-TkoO8Z07hI?start=8400",
  "C++ File Handling":       "-TkoO8Z07hI?start=9000",
  "Build a Calculator (C++)":"-TkoO8Z07hI?start=9600",
  "Final C++ Project":       "-TkoO8Z07hI?start=10000",

  // ── DSA ──────────────────────────────────────────────────────
  "Arrays & Big O":          "BBpAmxU_NQo",
  ...
  "SELECT & FROM":           "HXV3zeQKqGY?start=300",
  "WHERE & AND/OR":          "HXV3zeQKqGY?start=600",
  "ORDER BY & LIMIT":        "HXV3zeQKqGY?start=900",
  ...
  "JavaScript for Web":      "lfmg-oAi-NA",
  ...
  // ── OTHERS ───────────────────────────────────────────────────
  "What is Git?":            "USjZcfj8ckM",
  "Git Installation":        "USjZcfj8ckM?start=120",
  "Git Branches":            "e2IbNHi5ard",
  "What is Docker?":         "rOTqprHv1YE",
  "Docker Containers":       "rOTqprHv1YE?start=300",
  "What is Machine Learning?":"ukzFI9rgwfU",
  "What is Data Science?":   "X3paOmcrTjQ",
  "What is NumPy?":          "QUT1VHiLrmI",
  "What is Pandas?":         "vmEHCKcdykY",
  "What is C?":              "87SH2Cn0s9A",
  "C Setup":                 "87SH2Cn0s9A?start=120",
  "Variables in C":          "87SH2Cn0s9A?start=600",
};
function getYT(l: string) {
  const val = YT[l] || 'ix9cRaBkVe0';
  // Convert ?start= to &start= for embed URLs
  return val.replace('?start=', '&start=');
}
...
function LessonPage({ course, onBack }: { course:any; onBack:()=>void }) {
  ...
  return (
    <div style={{display:'grid',gridTemplateColumns:'200px 1fr 260px',height:'100vh',background:'#080b12',fontFamily:'system-ui,sans-serif',overflow:'hidden'}}>
      <style>{`
