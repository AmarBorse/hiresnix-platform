    ...
    <div className="p-4 md:p-6 min-h-screen" style={{ background: '#0a0f1e', fontFamily: 'Inter, sans-serif' }}>
      ...
      {projects.length === 0 ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          {/* Add more */}
          {projects.length < 10 && (
            <button onClick={openAdd} className="rounded-2xl p-6 flex flex-col items-center justify-center gap-3 transition-all" style={{ border: '1px dashed rgba(99,102,241,0.35)', background: 'rgba(99,102,241,0.05)', minHeight: '200px' }}>
